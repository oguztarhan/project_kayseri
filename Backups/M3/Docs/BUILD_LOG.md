...
## M3 — Idle layer (next)
Goal: managers (automate stations + bonus), offline earnings (timestamp accrual + welcome-back, cap), trusted-time / anti clock-cheat, cloud-save interface (local impl now).
