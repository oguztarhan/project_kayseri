...
namespace Game.Gameplay
{
    ...
    /// plus a burst on tap (GDD §3). A hired manager multiplies its rate (GDD §6).
    /// </summary>
    public sealed class MineStation : MonoBehaviour, IUpgradable, IProducer
    {
        ...
        private void OnTick() => Output.Add(new BigDouble(config.RateAtLevel(Level) * RateMultiplier * _clock.TickInterval));
