...
namespace Game.Systems
{
    ...
    /// dev stubs now, real SDKs at ship time), builds economy + prestige, loads the save, grants offline
    /// earnings (GDD §7), then loads Main. Drives the GameClock each frame (sim decoupled — GDD §14.5).
    /// </summary>
    public sealed class GameBootstrap : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // Facades (dev stubs now, real SDKs need package installs at ship time)
