...
namespace Game.Systems
{
    ...
    /// builds the economy + prestige, loads the save, grants offline earnings (GDD §7), then loads
    /// the Main scene. Drives the GameClock each frame — sim decoupled from render (GDD §14.5).
    /// </summary>
