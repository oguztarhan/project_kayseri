...
namespace Game.UI
{
    ...
    public sealed class HudUGUI : MonoBehaviour
    {
        ...
        private void Build()
        {
            ...
            vlg.spacing = 6f; vlg.childControlWidth = true; vlg.childControlHeight = true; vlg.childForceExpandWidth = true; vlg.childForceExpandHeight = false;
            ...
            wrt.anchorMin = new Vector2(0.5f, 1f); wrt.anchorMax = new Vector2(0.5f, 1f); wrt.pivot = new Vector2(0.5f, 1f);
            wrt.sizeDelta = new Vector2(540f, 210f); wrt.anchoredPosition = new Vector2(0f, -128f);
        ...
        {
            if (_world == null || _economy == null || _wallet == null)
            {
