...
namespace Game.Gameplay
{
    ...
    /// product inventory is filled by cargo trucks; per-unit value comes from each product's BaseValue.
    /// </summary>
    public sealed class Market : MonoBehaviour, IUpgradable
    {
        ...
        private void OnTick()
        {
            ...
            BigDouble budget = new BigDouble(config.RateAtLevel(Level) * _clock.TickInterval);
