...
## M6 — Polish & ship (next)
Goal (package-free framework + art): QualityConfig/adaptive fps, AccessibilityConfig, Audio/VFX/Juice/Haptic facades + configs, set-dressing art (trees/rocks/clouds), device profiling. *(Themed uGUI HUD, real audio/VFX content, and localization strings need a UI pass / audio assets / the Localization package — documented at completion.)*
