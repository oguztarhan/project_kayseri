...
| 4.1 — First-session shop clarity | Claude | Suppress or replace the incompatible ore tutorial on shop Main; make cash and shop state readable in the existing HUD | Fresh 1-1 panel is not blocked; first sale and upgrade visibly change the shop-facing HUD; no economy or save mutation |
